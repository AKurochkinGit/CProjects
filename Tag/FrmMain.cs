...
namespace Tag
{
    public partial class Tag : Form
    {
        ...
        {
            userData = new List<GameResult>();
            using (FileStream fr = new FileStream(path, FileMode.Open))
            {
                if (fr.Length > 0)
                {
                    bf = new BinaryFormatter();
                    userData = (List<GameResult>)bf.Deserialize(fr);
                }
            }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (g.isFinished())
            {
                ...
                userData.Add(new GameResult(player, startTime, time, count));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                g.Table[3, 3] = 0;
                gameTimer.Stop();
                userData.Add(new GameResult(textBoxPlayer.Text, startTime, time, Convert.ToInt32(textBoxMot.Text)));
